...
N = 10
whisker_names = ['RB4','RB3','RB2','RC2','RC1','RA2','RB1','RA1','RC3','RA3']

# Base motion parameters.
amp    = 1.2+0.5      # Amplitude of whisking motion.
freq   = 1.0      # Frequency of whisking motion.
offset = 0.70     # Offset of whisking motion.
base_motion = (amp, freq, offset)

# Surface parameters. (Sphere)
R = .015                           # Radius 
(X, Y, Z) = (.015, .020, -.005)    # Center position
